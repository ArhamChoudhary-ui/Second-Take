...
Run the README setup and verification commands. Keep changes scoped to a user-visible problem and include a reproducible example in the pull request. Preserve the lockfile, third-party notices and explicit simulation labels.
