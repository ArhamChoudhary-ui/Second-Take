...
Publish the reviewed source to your public GitHub account, record the actual English demo and test with people who did not build it. Add only measured findings to the submission. Follow `docs/submission/checklist.md` and `docs/submission/demo-script.md`.
