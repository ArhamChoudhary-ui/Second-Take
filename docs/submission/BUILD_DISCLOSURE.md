...
Preserved notices include `build/sites-vite-plugin.LICENSE` and `vendor/shadcn-tailwind-4.13.0.LICENSE.md`. The project’s original code is offered under the root MIT license. No third-party media is needed for the demo; the favicon and interface graphics are simple project styling.
