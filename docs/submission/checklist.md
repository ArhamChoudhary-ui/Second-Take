...
Reviewed against the [official hackathon rules](https://amazonappdev2026.devpost.com/rules) on September 15, 2026. The stated submission window is August 31–October 23, 2026, ending at 12:00 pm Pacific Time. Recheck organizer updates before submitting.
...
- [x] Sample booking and recovery engine.
- [x] Three independent practice scenarios and action evidence.
- [x] Source, local run instructions and MIT license.
- [x] MCP endpoint used by the browser and compiled-route verification.
- [x] Narration and screen-action script.
- [x] Draft description, product feedback and observed friction log.
- [x] Plain-language explanation and presenter questions.

- [x] Editable reservation previews, field comparisons and expiry recovery.
- [x] Restaurant, appointment and event calendar snapshots.
- [x] Request guide, keyboard entry point and reduced-motion support.
- [x] Public-source exporter and GitHub verification workflow.
- [x] Attribution and recorded work disclosure.
...
- [ ] Test desktop and narrow/mobile UI layouts.
...
- [ ] Replace all placeholders in `docs/submission/project-description.md`.
...
- [ ] Submit the form before the deadline and check its submitted status.
